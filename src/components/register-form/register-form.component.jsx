...
class RegisterForm extends React.Component{
        ...
        handleFirstnameChange = evt =>{
            ...
            let svg=document.getElementById('svg1');var alph= /^[a-zA-Z]+$/;
            var alph = /^[a-zA-Z]+$/;
  ...
  <div className="reg-form">        
        ...
        <div className="form-row mb-4">
            ...
            <input type="email" id="email" className="input-reg mb-4 input-reg" placeholder="E-mail"/>
        ...
        <input type="password" id="password" className="input-reg" placeholder="Password" aria-describedby="defaultRegisterFormPasswordHelpBlock"/>
        ...
        <path id="svg6" d="M11.2036 23.815C12.4326 24.1962 13.7131 24.3851 14.9999 24.375C20.1249 24.46 25.3224 20.8575 28.5299 17.3275C29.2431 16.5376 29.2431 15.3361 28.5299 14.5462C27.3682 13.2708 26.0809 12.1158 24.6874 11.0987" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        <path id="svg7" d="M18.0162 7.8525C17.0296 7.60839 16.0162 7.48996 14.9999 7.5C9.95994 7.4175 4.74994 10.94 1.47244 14.545C0.759187 15.3349 0.759187 16.5364 1.47244 17.3263C2.46522 18.4174 3.55005 19.4211 4.71494 20.3263" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        <path id="svg8" d="M10.311 15.9375C10.311 14.6941 10.8051 13.5016 11.6844 12.6225C12.5638 11.7434 13.7564 11.2497 14.9998 11.25" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        <path id="svg9" d="M19.6863 15.9362V15.9362C19.6866 17.1795 19.193 18.3719 18.3142 19.2512C17.4354 20.1305 16.2432 20.6247 15 20.625" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
